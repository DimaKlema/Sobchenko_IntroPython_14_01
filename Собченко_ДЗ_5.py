# Руководствуясь пройденным материалом,
# я обнаружил несколько решений для большенства этих задач.
# И потому, если какие-либо мои решения будут не рациональными, я их переделаю
